...
<body>
    <main>
        <h1>おすすめラーメン店</h1>
        <a href="admin" style="display:inline-block;margin-bottom:1em;padding:0.5em 1em;background:#457b9d;color:#fff;border-radius:4px;text-decoration:none;">管理画面へ</a>
